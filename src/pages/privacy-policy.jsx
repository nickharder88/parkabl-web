...
function PrivacyPolicy() {
  return (
    <Box px={16} py={2}>
      ...
      <Typography>
        Nicholas Harder built the Parkabl app as a Commercial app. This SERVICE
        is provided by Nicholas Harder and is intended for use as is.
      </Typography>{' '}
      <Typography>
      ...
      <Typography>
        ...
        Terms and Conditions, which is accessible at Parkabl unless otherwise
      ...
      <Typography>
        ...
        but not limited to name,email,password,location,device information,app
        usage. The information that I request will be retained on your device
      ...
      <Typography>
        ...
        hesitate to contact me at nickharder88@gmail.com.
      </Typography>
    </Box>
  );
}
